...
//SCRIPT PARA VALIDACAO DA MOBILIDADE DOS NOS VEICULARES
//UTILIZANDO CLASSES CUSTOMIZADAS DE MOBILIDADE
//RODAR COMO:
//NS_LOG=ndn.fw.V2v ./waf --run _validacao_mobilidade_vehicular >> logv2v.txt 2>&1
...
//  cmd.AddValue ("fixedDistance", "Length of the highway. Number of cars will be set as (fixedDistance / distance + 1). If not set, there are 1000 cars", fixedDistance);
  ...
  mobility.SetMobilityModel ("ns3::Vehicular2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (0.0, 600.0, 0.0, 600.0)),
                             "Distance", DoubleValue (100.0),
                             "Mode", EnumValue (Vehicular2dMobilityModel::MODE_DISTANCE),
  ...
  consumerHelper.SetPrefix ("/aplicacaoGPS/600/300");
