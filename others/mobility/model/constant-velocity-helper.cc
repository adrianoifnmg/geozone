...
int
ConstantVelocityHelper::SortNewDirection (void)
{
...
double
ConstantVelocityHelper::GetNewDirection (void)
{
	...
	if (m_atualDirection == 0) return double_t(0.0);  // movimento para a frente
	if (m_atualDirection == 1) return double_t(1.57); // movimento para baixo
	if (m_atualDirection == 2) return double_t(3.14); // movimento para tras
	if (m_atualDirection == 3) return double_t(4.71); // movimento para cima
	return double_t(0.0);
}
